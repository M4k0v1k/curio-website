      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="index.php">
            <img class="logo__img" src="images/logo2.png" alt="KenyaCurio logotype" width="237" height="19">
          </a>
        </div>
        ...
        <nav class="main-nav">
          <ul class="categories">
            ...
            <li class="categories__item">
              <a class="categories__link" href="http://localhost/ecommerce-website/index.php">
                Home
            ...
            <li class="categories__item">
              <a class="categories__link" href="http://localhost/ecommerce-website/about.php">
                About us
