...
<label class="col-md-3 control-label" > Select A shop </label>

<div class="col-md-6" >

<select class="form-control" name="shop"><!-- select shop Starts -->
