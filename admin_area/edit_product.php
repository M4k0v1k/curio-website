...
$get_shop = "select * from shops where shop_id='$m_id'";

$run_shop = mysqli_query($con,$get_shop);

$row_manfacturer = mysqli_fetch_array($run_shop);

$shop_id = $row_manfacturer['shop_id'];

$shop_title = $row_manfacturer['shop_title'];
...
while($row_manfacturer = mysqli_fetch_array($run_shop)){
