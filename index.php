    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">support@kenyacurio.com</a>
            </div>
          </div>
      ...
      <div class="banners">
        ...
        <div class="banner-award">
            <span>Unique, handmade crafts, </span><br> crafted with love.  
          </div>
