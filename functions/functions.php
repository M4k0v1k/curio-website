...
$db = mysqli_connect("localhost","root","","ecom_store","3306");
...
$get_shop = "select * from shops where shop_id='$shop_id'";

$run_shop = mysqli_query($db,$get_shop);
...
<p class='btn btn-primary'> $shop_name </p>
