<div class="panel panel-default sidebar-menu"><!-- panel panel-default sidebar-menu Starts -->
    ...
    <li class="<?php if (isset($_GET['register_shop'])) { echo 'active'; } ?>">
        <a href="my_account.php?register_shop"> <i class="fa fa-plus"></i> Register Shop </a>
    </li>

    <li class="<?php if (isset($_GET['add_product'])) { echo 'active'; } ?>">
        <a href="my_account.php?add_product"> <i class="fa fa-plus-circle"></i> Add Product</a>
    </li>
