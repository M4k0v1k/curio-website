...
if (!isset($_SESSION['customer_email'])) {
    ...
    $get_shop = "SELECT * FROM shops WHERE customer_name='$customer_name'";
    $run_shop = mysqli_query($con, $get_shop);
    $row_shop = mysqli_fetch_array($run_shop);

    if (!$row_shop) {
        echo "<script>alert('No shop found for this user. Please register a shop first.')</script>";
        echo "<script>window.open('register_shop.php','_self')</script>";
        exit();
    }
        ...
        <div class="panel panel-default"><!-- panel panel-default Starts -->
            <div class="panel-heading"><!-- panel-heading Starts -->
                <h3 class="panel-title">
                    <i class="fa fa-money fa-fw"></i> Shop Dashboard - <?php echo $shop_name; ?>
                </h3>
            ...
            <div class="panel-body"><!-- panel-body Starts -->
                <form class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" value="<?php echo $shop_name; ?>" disabled>
                        </div>
                    </div><!-- form-group Ends -->
...
if (isset($_POST['submit'])) {
    ...
    $insert_product = "INSERT INTO products (p_cat_id, cat_id, shop_id, date, product_title, product_url, product_img1, product_img2, product_img3, product_price, product_psp_price, product_desc, product_features, product_video, product_keywords, product_label, status) VALUES ('$product_cat', '$cat', '$shop_id', NOW(), '$product_title', '$product_url', '$product_img1', '$product_img2', '$product_img3', '$product_price', '$psp_price', '$product_desc', '$product_features', '$product_video', '$product_keywords', '$product_label', '$status')";
